...
function freichatx_get_hash($ses){
       ...
       if(is_file("C:/wamp/www/test/freichat/hardcode.php")){

               require "C:/wamp/www/test/freichat/hardcode.php";
...
?>
                        <script type="text/javascript" language="javascipt"src="http://localhost/test/freichat/client/main.php?id=<?php echo $ses;?>&xhash=<?php echo freichatx_get_hash($ses); ?>"></script>                        
	<link rel="stylesheet" href="http://localhost/test/freichat/client/jquery/freichat_themes/freichatcss.php" type="text/css">
<!--===========================FreiChatX=======END=========================-->                    
    </head>
    <body>
